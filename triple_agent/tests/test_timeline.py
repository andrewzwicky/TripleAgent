...
def test_calculate_elapsed_time():
    events = [
        ("spy", "01:54.1", "sipped drink.", (Characters.Q,), (Roles.Spy,), (None,),),
        ...
        ("sniper", "01:11.1", "marked suspicious.", (Characters.T,), (None,), (None,),),
        ...
        ("sniper", "00:41.1", "marked suspicious.", (Characters.F,), (None,), (None,),),
        ...
        ("sniper", "01:17.6", "marked suspicious.", (Characters.I,), (None,), (None,),),
        ...
        ("sniper", "00:58.0", "took shot.", (Characters.T,), (None,), (None,)),
        (
            "game",
            "00:54.3",
