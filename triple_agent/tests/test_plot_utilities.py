...
CREATE_DATA_DICTIONARY_TEST_CASES = [
    (
        ...
        Counter(
            {
                ActionTest.Green: 14 / 52,
                ActionTest.White: 34 / 52,
                ActionTest.Red: 1 / 52,
                ActionTest.Ignored: 2 / 52,
                ActionTest.Canceled: 1 / 52,
            }
        ),
    ),
    (
        ...
        defaultdict(
            Counter,
            {
                ...
                "Max Edward Snax": Counter(
                    {
                        ActionTest.Green: 7 / 30,
                        ActionTest.White: 21 / 30,
                        ActionTest.Red: 1 / 30,
                        ActionTest.Canceled: 1 / 30,
                    }
                ),
            },
        ),
    ...
    (
        ...
        defaultdict(
            Counter,
            {
                ...
                "Gallery": Counter(
                    {
                        ActionTest.Green: 5 / 24,
                        ActionTest.White: 17 / 24,
                        ActionTest.Ignored: 1 / 24,
                        ActionTest.Canceled: 1 / 24,
                    }
                ),
