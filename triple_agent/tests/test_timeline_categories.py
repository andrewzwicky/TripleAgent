...
@pytest.mark.parametrize(
    "actor, time_str, event, cast_name, exp_time, exp_elapsed_time, role, books, exp_category, exp_mission, exp_action_test",
    CATEGORY_TEST_CASES,
)
def test_categorize(
    actor,
    ...
    assert t_event.elapsed_time == exp_elapsed_time
